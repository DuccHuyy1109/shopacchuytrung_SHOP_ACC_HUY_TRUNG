/**
 * Bộ icon SVG inline — đồng bộ phong cách "ngầu / chiến" cho toàn site.
 * Nét stroke 2px, bo tròn, kế thừa currentColor -> dễ tô màu lửa/gold + glow.
 * Dùng: <Flame className="w-5 h-5 text-fire-500" />
 */
...
export const Crown = (p: IconProps) => (
  <Base {...p}>
    <path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.183 5.5a.5.5 0 0 1 .798.519l-2.834 10.246a1 1 0 0 1-.956.734H6.81a1 1 0 0 1-.957-.734L3.02 6.02a.5.5 0 0 1 .798-.519l4.276 3.664a1 1 0 0 0 1.516-.294z" />
    <path d="M5 21h14" />
  </Base>
);
...
export const Headset = (p: IconProps) => (
  <Base {...p}>
    <path d="M3 11h3a1 1 0 0 1 1 1v6a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1z" />
    <path d="M18 11h3v6a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-6a1 1 0 0 1 1-1z" />
